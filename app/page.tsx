...
export default function MarketingHome() {
  return <main className={styles.page}>
    ...
    <aside><div className={styles.miniBrand}><Image className={styles.miniBrandLogo} src="/brand/mergevista-primary-dark-transparent.png" alt="MergeVista" width={714} height={233}/></div><small>WORKSPACE</small>{["Overview","Applications","Infrastructure","Sites","Contracts & Licenses","TSA Management","Program Management"].map((x,i)=><div key={x} className={i===0?styles.activeNav:""}><i>{["◫","▦","▤","◎","◇","↔","✓"][i]}</i>{x}</div>)}</aside>
