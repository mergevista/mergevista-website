...
export default function SiteHeader({ variant = "full" }: SiteHeaderProps) {
  ...
  return <header className={styles.header}>
    ...
    {!focused && <nav className={styles.links} aria-label="Primary navigation"><Link href="/platform">Platform</Link><Link href="/solutions">Solutions</Link><Link href="/use-cases">Use Cases</Link><Link href="/ai-capabilities">AI Capabilities</Link><Link href="/security">Security</Link><Link href="/insights">Insights</Link><Link href="/about">About</Link></nav>}
